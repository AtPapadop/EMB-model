...
python3 ~/EMB/src/Model_train.py -M Efficientnet_b0 -O sgd -S linear -s "(start_lr=5e-4, end_lr=5e-8, iters=150)" -l 5e-4 -E 150 -b 128 -o train_linear.pth
...
python3 ~/EMB/src/Model_test.py -i Efficientnet_b0/train_linear.pth
